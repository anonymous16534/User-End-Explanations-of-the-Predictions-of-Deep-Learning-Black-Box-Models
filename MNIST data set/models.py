...
class MNIST_L5_3D(nn.Module):
    def __init__(self, dropout=0.0):
        super(MNIST_L5_3D, self).__init__()
...
class MNIST_L5_long(nn.Module):
    def __init__(self, dropout=0.0):
        super(MNIST_L5_long, self).__init__()
...
class exp_MNIST_L5(nn.Module):
    def __init__(self, dropout=0.0):
        super(exp_MNIST_L5, self).__init__()
...
class exp_MNIST_L5_2(nn.Module):
    def __init__(self, dropout=0.0):
        super(exp_MNIST_L5_2, self).__init__()
        ...
        self.fc1 = nn.Linear(256 * 5**2 , 200)
        self.fc2 = nn.Linear(200, 10)
        self.relu = nn.ReLU()
        self.dropout = nn.Dropout(p=dropout)
...
def ResNet34(pretrained = True, number_of_classes = 10):
